<?php get_header(); ?>
        ...
        $working_hours = "<table class='store_locator_grid_results store_locator_working_hours'><tr><td colspan='3'>" . __("Working Hours", "wpmsl") . "</td></tr>";
        ...
        $days = array(
                ...
                __("Sunday","wpmsl"));
        foreach ($days as $day) {
            $working_hours .= "<tr class='".(($store_metaDays[$day]['status'] == "1") ?"store-locator-open":"store-locator-closed") ."'><td>" . $day . "</td><td>" . (($store_metaDays[$day]['status'] == "1") ? __("Open", "wpmsl") : __("Closed", "wpmsl")) . "</td><td><span class='store_locator_start'>" . $store_metaDays[$day]['start'] . "</span><span class='store_locator_end'>" . $store_metaDays[$day]['end'] . "</span></td></tr>";
        }
        $working_hours .= "</table>";
                            ...
                            <li class="<?php echo ($item == "working_hours")?"store_locator_working_hours":""; ?>">
                                    ...
                                    switch ($item) {
                                        case 'name':
                                            ...
                                            break;
                                        case 'website':
                                            echo "<span>". __("Website: ", "wpmsl") ."</span>". $store_meta['store_locator_website'][0];
                                            break;
                                        case 'description':
                                            echo nl2br($store_meta['store_locator_description'][0]);
                                            break;
                                        case 'phone':
                                            echo "<span>". __("Phone: ", "wpmsl")."</span>" . $store_meta['store_locator_phone'][0];
                                            break;
                                        case 'fax':
                                            echo "<span>". __("Fax: ", "wpmsl") ."</span>". $store_meta['store_locator_fax'][0];
                                            break;
                                        case 'full_address':
                                            echo "<span>". __("Address: ", "wpmsl") ."</span>". $store_meta['store_locator_address'][0] . " " . $store_meta['store_locator_city'][0] . " " . $store_meta['store_locator_state'][0] . " " . $store_meta['store_locator_country'][0] . " " . $store_meta['store_locator_zipcode'][0];
                                            break;
                                        case 'working_hours':
                                        ...
                                        case 'managers':
                                            ...
                                            if ($sales) {
                                                echo "<span class='store_locator_managers_titles' >". __("Managers: ", "wpmsl")."</span><div class='store_locator_managers_wrapper'>";
...
<script>
    function  initializeMapFrontend(store_lat, store_lng) {
        ...
        google.maps.event.addListener(marker1, 'click', function () {
                infowindow.setContent("<?php echo __("Your location", "wpmsl"); ?>");

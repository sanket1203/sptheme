        ...
        <table class="store_locator_grid_results" style="margin: 0px;">
            <thead>
                ...
                foreach ($stores as $store) {
                        ...
                        switch ($column) {
                            ...
                            case 'working_hours':
                                ...
                                $days = array(
                                    ...
                                    __("Sunday","wpmsl"));
                                foreach ($days as $day) {
                                    $working_hours .= "<tr class='".(($metaDays[$day]['status'] == "1") ?'store-locator-open':'store-locator-closed') ."'><td>" . $day . "</td><td>" . (($metaDays[$day]['status'] == "1") ? __("Open", "wpmsl") : __("Closed", "wpmsl")) . "</td><td><span class='store_locator_start'>" . $metaDays[$day]['start'] . "</span><span class='store_locator_end'>" . $metaDays[$day]['end'] . "</span></td></tr>";
                                }
                                $working_hours .= "</table>";
                                echo $working_hours;
                                break;
                            ...
                            case 'gravity_form':
                                ...
                                <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-backdrop="static" data-keyboard="false"  data-target="#store-locator-modal-<?php echo $store->ID; ?>"><?php _e('Show Form', 'wpmsl'); ?></button>
                    ...
                    echo "<tr><td class='store-locator-not-found' style='text-align: center;' colspan='".count($columns)."'><span><i class='fa fa-map-marker' aria-hidden='true'></i></span><p>". __('No Store found','wpmsl') ."</p></td></tr>";
                }
                ?>
            </tbody>
        </table>
...
<?php
                ...
                echo '</div>';
                    ...
                    echo "<tr><td style='text-align: center;' colspan='".count($columns)."'><div class='store-locator-not-found'><i class='fa fa-map-marker' aria-hidden='true'></i><p>". __('No Store found','wpmsl') ."</p></div>" ."</td></tr>";
                }
